...
+ [Testing](#testing)
	* [Validator Testing](#validator-testing)
		 - [HTML Validator](#html-validator)
		 	- [HTML Results Home Page](#html-results-home-page)
			- [HTML Results Events Page](#html-results-events-page)
			- [HTML Results Gallery Page](#html-results-gallery-page)
			- [HTML Results Contact Page](#html-results-contact-page)
			- [HTML Thank You Page](#html-results-thank-you-page)
...
result for index.html HTML results index
 
result for events.html HTML results menu
 
result for gallery.html HTML results contact

result for contact.html HTML results contact
 
result for thank-you.html HTML results contact
 
Full validation results are available on github here :

HTML Results - Home Page

HTML Results - Menu Page

HTML Results - Contact Page

CSS Validator

result for styles.css CSS results
